...
GO
ALter table DBO.PLAYER ALTER COLUMN BIRTHDAY DATE NOT NULL
...
@MATCHID INT, @HOMECLUB INT, @AWAYCLUB INT, @HOMESCORE INT, @AWAYSCORE INT, @ROUNDID INT, @MATCHDAY DATE, @MATCHTIME TIME
AS
BEGIN
	INSERT INTO DBO.MATCH (MATCHID, HOMECLUB, AWAYCLUB, HOMESCORE, AWAYSCORE, ROUNDID, MATCHDAY, MATCHTIME) VALUES (@MATCHID, @HOMECLUB, @AWAYCLUB, @HOMESCORE, @AWAYSCORE, @ROUNDID, @MATCHDAY, @MATCHTIME)
END
...
AS
BEGIN
	UPDATE DBO.MATCH SET HOMECLUB=@HOMECLUB, AWAYCLUB=@AWAYCLUB, HOMESCORE= @HOMESCORE, AWAYSCORE= @AWAYSCORE, ROUNDID=@ROUNDID, MATCHDAY=@MATCHDAY, MATCHTIME=@MATCHTIME
