...
AS
BEGIN
	SELECT NAME, CLUBNAME,PLAYERTYPENAME, COUNT(*) AS SOBANTHANG
...
INSERT [dbo].[PARAMETER] ([PARAID], [MINAGE], [MAXAGE], [MINPLAYER], [MAXPLAYER], [MAXFOREIGNPLAYER], [GOALTYPEKIND], [MAXGOALTIME], [WINSCORE], [LOSESCORE], [DRAWSCORE], [PRIORITYCHARTS]) VALUES (N'1', 16, 40, 15, 22, 3, 3, 90, 3, 0, 1, NULL)
